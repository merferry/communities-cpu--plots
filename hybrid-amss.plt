...
plot 'hybrid-amss.csv' \
    ...
    '' using 2:($11/$6 )                                         title 'Dynamic Frontier LPA'         linestyle 3 with linespoints, \
    '' using 2:((0.002*$8  + 0.998*$12)/(0.002*$3  + 0.998*$7 )) title 'Dynamic Frontier Louvain-LPA' linestyle 4 with linespoints,
