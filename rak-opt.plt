...
set label "{/:Bold Pruning}"                         at screen 0.42,0.97 center font "Tahoma,11" textcolor rgb T[6]
set label "{/:Bold Strictness}"                      at screen 0.495,0.97 center font "Tahoma,11" textcolor rgb T[7]
