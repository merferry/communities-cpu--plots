...
plot 'louvain-del-am.csv' \
    ...
    '' using 4:((0.001*$5 + 0.999*$8 )/1000) title 'P-DF_L'   linestyle 4 with linespoints, \
    ...
    '' using 4:((0.001*$5 + 0.999*$8 )/1000):($4< 0.1? sprintf("%.2f", $6/(0.001*$5 + 0.999*$8 )) : "") with labels notitle offset character 0,character 0.7, \
    '' using 4:((0.001*$5 + 0.999*$8 )/1000):($4>=0.1? sprintf("%.2f", $6/(0.001*$5 + 0.999*$8 )) : "") with labels notitle offset character -3,character 0
